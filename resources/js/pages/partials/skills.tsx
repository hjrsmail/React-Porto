                  ...
                  <div className="w-full mx-auto pb-12 px-5 text-black dark:text-gray-300">
                        ...
                        {activeTab === 'pageOne' && (
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:pt-2 cursor-pointer">
                                    ...
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="size-7 md:size-11">
                                    ...
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          ...
                                          <div className="flex flex-col justify-start">
                                                <p className="text-sm md:text-lg">PHP</p>
                                          </div>
                                    </div>
                                    ...
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          ...
                                          <div className="flex flex-col justify-start">
                                                <p className="text-sm md:text-lg">Bootstrap</p>
                                          </div>
                                    </div>
                                    ...
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          ...
                                          <div className="flex flex-col justify-start">
                                                <p className="text-sm md:text-lg">Laravel</p>
                                          </div>
                                    </div>
                                    ...
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          ...
                                          <div className="flex flex-col justify-start">
                                                <p className="text-sm md:text-lg">NodeJS</p>
                                          </div>
                                    </div>
                                    ...
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          ...
                                          <div className="flex flex-col justify-start">
                                                <p className="text-sm md:text-lg">AlpineJS</p>
                                          </div>
                                    </div>
                              </div>
                        )}
                        ...
                        {activeTab === 'pageTwo' && (
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:pt-2 cursor-pointer">
                                    ...
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          ...
                                          <div className="flex flex-col justify-start">
                                                <p className="text-sm md:text-lg">GIT</p>
                                          </div>
                                    </div>

                                    {/* Github */}
                                    <div className="bg-transparent border border-gray-600 rounded-md md:h-[100px] py-2 md:py-0 p-0 md:p-2 md:gap-8 flex flex-col md:flex-row items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
                                          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="size-7 md:size-11"
                        ...
                        {activeTab === 'pageThree' && (
                              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:pt-2 text-dark">
                                    ...
                                    <div className="rounded-lg overflow-hidden border border-gray-900 bg-transparent shadow-sm">
                                          <div className="relative">
                                                <img src="img/sertif2.png"
                                                      className="w-full h-full transition-all duration-300 ease-in-out hover:scale-103 brightness-70 hover:brightness-100"
                                                      alt="mysertif" />
                                          </div>
                                    </div>
